...
export const BackgroundBeams = ({ className }: { className?: string }) => {
    ...
    return (
        <div
            className={cn(
                "absolute  h-full w-[99vw] inset-0  [mask-size:40px] [mask-repeat:no-repeat] flex items-center justify-center",
                className
            )}
        >
            <svg
                className=" z-0 h-full w-[99vw] pointer-events-none absolute "
                width="100%"
                height="100%"
                viewBox="0 0 696 316"
                fill="none"
