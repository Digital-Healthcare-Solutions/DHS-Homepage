...
import { SubjectiveElementType } from "../noteTypes"
...
export const SubjectiveElement: React.FC<{
    element: SubjectiveElementType
    ...
    const handleUpdate = <K extends keyof SubjectiveElementType>(
        key: K,
        value: SubjectiveElementType[K]
    ) => {
        updateElement<SubjectiveElementType>(element.id, { [key]: value })
    }
                ...
                >
                    ...
                    <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
                        <SheetContent className="z-[1001]">
                            <SheetHeader>
                                <SheetTitle>
                                    Custom Instructions for Subjective Section
                                </SheetTitle>
                                <SheetDescription>
                                    Add custom instructions to tell the AI what
                                    to focus on when generating the subjective
                                    section of the note.
                                </SheetDescription>
                            </SheetHeader>
