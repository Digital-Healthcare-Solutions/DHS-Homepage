...
import { AssessmentElementType } from "../noteTypes"
...
export const AssessmentElement: React.FC<{
    element: AssessmentElementType
    ...
    const handleUpdate = <K extends keyof AssessmentElementType>(
        key: K,
        value: AssessmentElementType[K]
    ) => {
        updateElement<AssessmentElementType>(element.id, { [key]: value })
    }
    ...
    return (
        <BaseElement element={element} toggleExpand={toggleExpand}>
            <div className="space-y-3">
                ...
                >
                    ...
                    <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
                        <SheetContent className="z-[1001]">
                            <SheetHeader>
                                <SheetTitle>
                                    Custom Instructions for Asessment Section
                                </SheetTitle>
                                <SheetDescription>
                                    Add custom instructions to help guide the AI
                                    in generating the assessment section of your
                                    note. Try to keep it short and concise for
                                    optimal results.
                                </SheetDescription>
                            </SheetHeader>
                ...
                <div className="flex items-center justify-between">
                    <Label className="font-normal text-base">
                        Include Differential Diagnosis if discussed
                    </Label>
                    <Switch
                        checked={element.includeDifferential}
                        onCheckedChange={(value) => {
                            handleUpdate("includeDifferential", value)
                        }}
