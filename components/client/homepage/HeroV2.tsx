...
const HeroV2 = () => {
  return (
    <div className="relative h-[60rem] md:h-[40rem] w-full dark:bg-neutral-950 bg-white dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex items-center justify-center overflow-hidden pt-20 md:pt-0 mb-20">
      {/* Radial gradient */}
